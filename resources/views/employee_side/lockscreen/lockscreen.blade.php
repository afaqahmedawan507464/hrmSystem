    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
        ...
        <div class="row flex-center min-vh-100 py-6 text-center">
          <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4"><a class="d-flex flex-center mb-4"><img class="me-2" src="/public/assets/img/icons/spot-illustrations/falcon.png" alt="" width="58" /><span class="font-sans-serif fw-bolder fs-5 d-inline-block">Codemindz</span></a>
            <div class="card">
              ...
              <div class="card-body p-4 p-sm-5">
                <div class="avatar avatar-4xl">
                    @if (!empty(Auth::guard('employee')->user()->image))
                       <img  class="rounded-circle"  src="{{asset(Auth::guard('employee')->user()->image)}}" class="img-circle elevation-2" alt="" style="width: 75px;height:75px">
                    @else
                        <img  class="rounded-circle" src="/admin/dist/img/avators.jpg" class="img-circle elevation-2" alt="User Image"style="width: 75px;height:75px">
                    @endif

                </div>
                <h5 class="mt-3 mb-0">Hi! {{ Auth::guard('employee')->user()->employee_name }}</h5><small>Enter your password to access the setting.</small>
                <form action="{{ route('lockscreenLogin') }}" method="post" class="lockscreen-credentials">
                    @csrf
                  <div class="col">
                    <input class="form-control me-2 mb-2" type="password" placeholder="Enter your password" aria-label="User's password" aria-describedby="user-password" name="password" id="password"/>
                  </div>
                  <div class="col-auto ps-2">
                    <button class="btn btn-primary px-3 mb-2" type="submit">Login</button>
                  </div>
                </form>
              </div>
            </div>
