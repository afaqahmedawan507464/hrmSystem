    ...
    <div class="container-fluid px-1 py-5 mx-auto">
        <div class="row d-flex justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                <p class="blue-text">Edit Department Information.</p>
                ...
                <div class="card p-5">
                    ...
                    <form action="{{ route('hrupdateDepartments',$item->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                      {{-- <h5 class="text-center mb-4">Add Your Bank Accounts Details.</h5> --}}
                        <div class="row justify-content-between text-start">
                            ...
                            <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label">Department name<span class="text-danger"> *</span></label> <input type="text" name="departmentname" id="departmentname" class="form-control" placeholder="Enter departments" value="{{ old('departments') }}{{ $item->department_name }}"> </div>
                    ...
                    @else
                    <form action="{{ route('updateDepartments',$item->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                      {{-- <h5 class="text-center mb-4">Add Your Bank Accounts Details.</h5> --}}
                        <div class="row justify-content-between text-start">
