            ...
            <div class="col-md-6 p-3">
                <div class="d-flex flex-column justify-content-center align-items-start p-3">
                    ...
                    <div class="d-flex mt-4 justify-content-between">
                        ...
                        {{--  --}}
                        <p class="textparagraph mx-5">
                            <a href="{{ route('createProjectsPage') }}">More templete</a>
                        </p>
                    </div>
                    <br>
                    ...
                    <br>
                    <form action="{{ route('createProjectOperation') }}" class="row" method="post">
                        @csrf
                        <div class="col-12">
                         <label class="form-label" for="first-name">Project Name</label>
                         <input type="text" class="form-control w-100" id="projectname" name="projectname" placeholder="Project name" value="{{old('username')}}">
                        </div>
                        <br>
                        <div class="d-flex mt-3">
                           <button class="btn btn-primary w-100" type="submit">Create projects</button>
                        </div>
                     </form>
                </div>
            </div>
