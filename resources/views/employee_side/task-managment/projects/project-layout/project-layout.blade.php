...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none">
    <head>
		...
		<!-- Calendar CSS -->
		<link rel="stylesheet" href="https://smarthr.dreamstechnologies.com/laravel/template/public/assets/css/fullcalendar.min.css">
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<nav class="greedys sidebar-horizantal">
							<ul class="list-inline-item list-unstyled links">
								...
								<li class="submenu">
									<a href="#"><i class="fas fa-dashboard"></i> <span> Recent</span> <span class="menu-arrow"></span></a>
									<ul>
										@if ($projectsss->isEmpty())
											
										@else
										@foreach ($projectsss as $prosss)
										    <li><a href="{{ $prosss->id }}">{{ $prosss->project_name }}</a></li>
										@endforeach
										@endif
									</ul>
								</li>
						...
						<ul class="sidebar-vertical">
								...
								<li class="submenu">
									<a href="#"><i class="fas fa-home"></i> <span> Recent</span> <span class="fas fa-menu-arrow"></span></a>
									<ul>
										@if ($projectsss->isEmpty())
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane fade show active" id="v-pills-projects" role="tabpanel" aria-labelledby="v-pills-projects-tab">
								...
								<ul>
									...
									<li><a href="task-board.html" class="active">Task Board</a></li>
								</ul>
							</div>
