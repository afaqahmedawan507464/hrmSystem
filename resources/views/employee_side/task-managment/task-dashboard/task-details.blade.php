                  ...
                  <div class="row">
                     <div class="col-lg-8">
                        ...
                        {{--  --}}
                           <div class="d-flex">
                              {{--  --}}
                              <a class="px-2 mx-2 btn bg-light" href="" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="px-1 fas fa-project-diagram"></i>Add a child tasks</a>
                              {{--  --}}
                              {{-- <div class="d-flex">
                           ...
                           <div class="flexbox">
                              ...
                              <div class="chat-box w-100">
                                 ...
                                 <div class="px-3 pt-3 chat-box-footer">
                                    {{--  --}}
                                    <form action="{{ route('sendMsg') }}" method="post" enctype="multipart/form-data" class="d-flex">
                                       @csrf
                                       {{--  --}}
                     ...
                     <div class="col-lg-4">
                        ...
                        <form action="{{ route('changesProjects',$item->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row mt-3">
                           {{--  --}}
                           ...
                           <div class="col-6">
                              <select name="boardlist" id="boardlist" class="form-control text-center">
                                 @foreach ($selectTasks as $tasksss)  
                                 @endforeach
                                 <option value="{{ $tasksss->id }}">{{ $tasksss->task_list_name }}</option>
                                  @foreach ($taskBoard as $board)
                                    <option value="{{ $board->id }}">{{ $board->task_list_name }}</option>
                                  @endforeach
                              </select>
                           ...
                           <div class="text-center col-6">
                              <div class="dropdown kanban-action form-control">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h1 class="modal-title fs-5" id="staticBackdropLabel">{{ $projectDatasss->task_name }} | Child task</h1>
                  ...
                  <form action="{{ route('createChildNewTask') }}" method="post" enctype="multipart/form-data">
                     ...
                     <div class="input-block mb-3">
                       ...
                       <select class="form-control select" name="tasktype">
                         <option>Select</option>
                         @foreach ($taskType as $tasksTypes)
                              <option value="{{ $tasksTypes->id }}">{{ $tasksTypes->tasks_type_name }}</option>
                         @endforeach
                       </select>
                     </div>
                     <div class="input-block mb-3">
