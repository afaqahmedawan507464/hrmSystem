           ...
           <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
              ...
              <div class="card"> 
                 <div class="card-body">
                    ...
                    @else
                        @foreach ($selectBoard as $taskboarddata)
                            <div class="row px-3 py-3">
                                <form action="{{ route('createNewTask') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="input-block mb-3">
                                      ...
                                      <input type="text" class="form-control d-none" name="proid" id="proid" placeholder="task name .." value="{{ $taskboarddata->project_id }}">
                                      <input type="text" class="form-control d-none" name="tasklistboard" id="tasklistboard" value="{{ $taskboarddata->id }}">
                                        ...
                                        <div class="col-lg-2 col-md-6">
                                            <div class="submit-section text-center">
                                                <button class="btn btn-danger">
                                                    <a class="text-white py-2 px-3 text-decoration-none" href="{{ route('projectDashboard',$taskboarddata->project_id) }}"><i class="fas fa-angle-left"></i> <span class="mx-2 text-white">Back</span></a>
                                                </button>
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-md-6">
