    ...
    <div class="container-fluid px-1 py-5 mx-auto">
        <div class="row d-flex justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                <p class="blue-text">Update tasks type.</p>
                @if (Session::has('error_message'))
                      ...
                      <div class="alert alert-danger alert-dismissible fade show px-4" role="alert">
                        ...
                        @endif
                        @foreach ($oldTasksType as $tasksTypes)
                        @endforeach
                        <div class="card p-5">
                            <form action="{{ route('editOperations',$tasksTypes->id) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="input-block mb-3">
                                  <label class="col-form-label">Task type name</label>
                                  <input type="text" class="form-control" name="taskstypename" value="{{ $tasksTypes->tasks_type_name }}">
                                </div>
