      ...
      <div class="container" data-layout="container">
        ...
        <nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
          ...
          <div class="d-flex align-items-center">
            ...
            <a class="navbar-brand" href="{{ route('employeeDashboard') }}">
            ...
            <a class="navbar-brand" href="{{ route('hrDashboard') }}">
                <div class="d-flex align-items-center py-3"><span class="font-sans-serif">Codemindz</span>
                </div>
            </a>
            @endif
            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                @if (Auth::guard('employee')->user()->roll_status == 5)
                  {{-- navigation bar for adminsitrators --}}
                  <li class="nav-item">
                    <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard102" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard102">
                      <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-chart-pie"></span></span><span class="nav-link-text ps-1">Attendance</span>
                      </div>
                    </a>
                    <ul class="nav collapse show" id="dashboard102">
                      <li class="nav-item"><a class="nav-link active" href="{{ route('employeeAteendancesPage') }}" aria-expanded="false">
                  ...
                  <li class="nav-item">
                    ...
                    <ul class="nav collapse show" id="dashboard1">
                      <li class="nav-item"><a class="nav-link active" href="{{ route('hraddCompanyForm') }}" aria-expanded="false">
                          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Add Company</span>
                          </div>
                        </a></li>
                        <!-- more inner pages-->
                        <li class="nav-item"><a class="nav-link active" href="{{ route('hrlistCompany') }}" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Company Details</span>
                            </div>
                          </a></li>
                    </ul>
                  </li>
                  ...
                  <li class="nav-item">
                    <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard2" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard2">
                      <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-building"></span></span><span class="nav-link-text ps-1">Departments</span>
                      </div>
                    </a>
                    <ul class="nav collapse show" id="dashboard2">
                      <li class="nav-item"><a class="nav-link active" href="{{ route('hraddDepartmentForm') }}" aria-expanded="false">
                          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Add Department</span>
                          </div>
                        </a></li>
                        <!-- more inner pages-->
                        <li class="nav-item"><a class="nav-link active" href="{{ route('hrlistDepartments') }}" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Department Details</span>
                            </div>
                          </a></li>
                          <!-- more inner pages-->
                    </ul>
                  ...
                  <li class="nav-item">
                    <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard3" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard3">
                      <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-envelope"></span></span><span class="nav-link-text ps-1">Leaves Details</span>
                      </div>
                    </a>
                    <ul class="nav collapse show" id="dashboard3">
                          <!-- more inner pages-->
                        <li class="nav-item"><a class="nav-link active" href="{{ route('hrapproveLeaves') }}" aria-expanded="false">
                              <div class="d-flex align-items-center"><span class="nav-link-text ps-1">List Leaves</span>
                              </div>
                            </a>
                        </li>
                            <!-- more inner pages-->
                            <li class="nav-item"><a class="nav-link active" href="{{ route('hrlistLeaves') }}" aria-expanded="false">
                              <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Approved Leaves</span>
                              </div>
                            </a>
                        </li>
                            <!-- more inner pages-->
                  ...
                  <li class="nav-item">
                    <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard4" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard4">
                      <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-users"></span></span><span class="nav-link-text ps-1">Employees</span>
                      </div>
                    </a>
                    <ul class="nav collapse show" id="dashboard4">
                      {{-- <li class="nav-item"><a class="nav-link active" href="{{ route('employeeRegisterationPage') }}" aria-expanded="false">
                          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">New Employee</span>
                          </div>
                        </a></li> --}}
                        <!-- more inner pages-->
                        <li class="nav-item"><a class="nav-link active" href="{{ route('hrlistEmployee') }}" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">List Employees</span>
                            </div>
                          </a></li>
                          
                          <!-- more inner pages-->
                          <li class="nav-item"><a class="nav-link active" href="{{ route('hraddEmployeeCategoryForm') }}" aria-expanded="false">
                              <div class="d-flex align-items-center"><span class="nav-link-text ps-1">New employee type</span>
                              </div>
                            </a></li>
                            <!-- more inner pages-->
                            <li class="nav-item"><a class="nav-link active" href="{{ route('hrlistEmployeeCategory') }}" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Availible Categories</span>
                                </div>
                              </a></li>
                              <!-- more inner pages-->
                    </ul>
                  ...
                  {{--  --}}
                  <li class="nav-item">
                    <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard5" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard5">
                      <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-wallet"></span></span><span class="nav-link-text ps-1">Saleries</span>
                      </div>
                    </a>
                    <ul class="nav collapse show" id="dashboard5">
                      <li class="nav-item"><a class="nav-link active" href="{{ route('userSalery') }}" aria-expanded="false">
                          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Employee Salery List</span>
                          </div>
                        </a>
                      </li>
                      {{--  --}}
                      ...
                      {{--  --}}
                      <li class="nav-item"><a class="nav-link active" href="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Employee Salary Slip</span>
                        </div>
                      </a>
                    </li>
                    </ul>
                  ...
                  {{--  --}}
                  <li class="nav-item">
                    <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard6" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard6">
                      <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-tasks"></span></span><span class="nav-link-text ps-1">Task Managment</span>
                      </div>
                    </a>
                    <ul class="nav collapse show" id="dashboard6">
                      <li class="nav-item">
                        <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard7" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard7">
                          <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-clipboard-list"></span></span><span class="nav-link-text ps-1">Your work</span>
                          </div>
                        </a>
                        <ul class="nav collapse show" id="dashboard7">
                          <li class="nav-item"><a class="nav-link active" href="index.html" aria-expanded="false">
                              <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Assigned to me</span>
                              </div>
                            </a></li>
                            <!-- more inner pages-->
                            <li class="nav-item"><a class="nav-link active" href="index.html" aria-expanded="false">
                              <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Recent</span>
                              </div>
                            </a></li>
                            <!-- more inner pages-->
                        </ul>
                      ...
                      {{--  --}}
                      <li class="nav-item">
                        <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard8" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard8">
                          <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-project-diagram"></span></span><span class="nav-link-text ps-1">Projects</span>
                          </div>
                        </a>
                        <ul class="nav collapse show" id="dashboard8">
                          <li class="nav-item"><a class="nav-link active" href="{{ route('projectList') }}" aria-expanded="false">
                              <div class="d-flex align-items-center"><span class="nav-link-text ps-1">View all projects</span>
                              </div>
                            </a></li>
                            <!-- more inner pages-->
                            <li class="nav-item"><a class="nav-link active" href="{{ route('createProjectsPage') }}" aria-expanded="false">
                              <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Create projects</span>
                              </div>
                            </a></li>
                            <!-- more inner pages-->
                        </ul>
                      ...
                      {{--  --}}
                      <li class="nav-item">
                        <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard9" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard9">
                          <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-search"></span></span><span class="nav-link-text ps-1">Filters</span>
                          </div>
                        </a>
                        <ul class="nav collapse show" id="dashboard9">
                          <li class="nav-item"><a class="nav-link active" href="{{ route('viewTasks') }}" aria-expanded="false">
                              <div class="d-flex align-items-center"><span class="nav-link-text ps-1">View all filters</span>
                              </div>
                            </a></li>
                            <!-- more inner pages-->
                            <li class="nav-item"><a class="nav-link active" href="index.html" aria-expanded="false">
                              <div class="d-flex align-items-center"><span class="nav-link-text ps-1">View all issues</span>
                              </div>
                            </a></li>
                            <!-- more inner pages-->
                        </ul>
                      ...
                      {{--  --}}
                      <li class="nav-item">
                        <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard11" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard11">
                          <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-chart-pie"></span></span><span class="nav-link-text ps-1">Dashboard</span>
                          </div>
                        </a>
                        <ul class="nav collapse show" id="dashboard11">
                          <li class="nav-item"><a class="nav-link active" href="index.html" aria-expanded="false">
                              <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Team dashboard</span>
                              </div>
                            </a>
                            <!-- more inner pages-->
                        </ul>
                      ...
                      <li class="nav-item">
                        <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard10" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard10">
                          <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-users"></span></span><span class="nav-link-text ps-1">Teams</span>
                          </div>
                        </a>
                        <ul class="nav collapse show" id="dashboard10">
                            <!-- more inner pages-->
                            <li class="nav-item"><a class="nav-link active" href="{{ route('teamList') }}" aria-expanded="false">
                              <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Team List</span>
                              </div>
                            </a></li>
                        </ul>
                      </li>
                      ...
                      {{--  --}}
                      <li class="nav-item">
                        <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard12" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard12">
                          <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-plus"></span></span><span class="nav-link-text ps-1">Create</span>
                          </div>
                        </a>
                        <ul class="nav collapse show" id="dashboard12">
                          <li class="nav-item"><a class="nav-link active" href="{{ route('projectList') }}" aria-expanded="false">
                              <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Create a projects</span>
                              </div>
                            </a>
                            <!-- more inner pages-->
                        </ul>
        ...
        <div class="content">
          <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
                      ...
                      <div class="list-group list-group-flush fw-normal fs--1">
                        ...
                        @else
                           ...
                           <div class="list-group-item">
                            <a class="notification notification-flush" href="{{ route('employeemarkSingleNotifications',$item->id) }}">
                              <div class="notification-avatar">
                                <div class="avatar avatar-2xl me-3">
                                    @if(empty($item->image))
                                        <img class="rounded-circle" src="admin/dist/img/avators.jpg" alt="" />
                                    @else
                           ...
                           @else
                           <div class="list-group-item">
                            <a class="notification notification-flush notification-unread" href="{{ route('employeemarkSingleNotifications',$item->id) }}">
                              <div class="notification-avatar">
                                <div class="avatar avatar-2xl me-3">
                                  @if(empty($item->image))
                                     <img class="rounded-circle" src="admin/dist/img/avators.jpg" alt="" />
                    ...
                    <div class="scrollbar-overlay" style="max-height:19rem">
                      <div class="list-group list-group-flush fw-normal fs--1">
                        ...
                        @else
                           ...
                           @if ($item->readBySp == 1)
                           <div class="list-group-item">
                            <a class="notification notification-flush" href="{{ route('markSingleNotifications',$item->id) }}">
                              <div class="notification-avatar">
                                <div class="avatar avatar-2xl me-3">
                                    @if(empty($item->image))
                                        <img class="rounded-circle" src="admin/dist/img/avators.jpg" alt="" />
                           ...
                           @else
                           <div class="list-group-item">
                            <a class="notification notification-flush notification-unread" href="{{ route('markSingleNotifications',$item->id) }}">
                              <div class="notification-avatar">
                                <div class="avatar avatar-2xl me-3">
                                  @if(empty($item->image))
                                     <img class="rounded-circle" src="admin/dist/img/avators.jpg" alt="" />
              ...
              <li class="nav-item dropdown"><a class="nav-link pe-0" id="navbarDropdownUser" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                  <div class="bg-white dark__bg-1000 rounded-2 py-2">
                    ...
                    @if (Auth::guard('employee')->user()->roll_status == 4)
                    <a class="dropdown-item" href="{{ route('employeeDashboard') }}">Profile &amp; account</a>
                    @elseif (Auth::guard('employee')->user()->roll_status == 3)
                    ...
                    {{-- <a class="dropdown-item" href="{{ route('employeeAccountSetting') }}">Profile &amp; account</a> --}}
                    @elseif (Auth::guard('employee')->user()->roll_status == 5)
                    <a class="dropdown-item" href="{{ route('hrProfile') }}">Profile &amp; account</a>
                    @endif
                    ...
                    {{-- <a class="dropdown-item" href="{{ route('lockScreen') }}">Settings</a> --}}
                    @elseif (Auth::guard('employee')->user()->roll_status == 5)
                    <a class="dropdown-item" href="{{ route('hremployeeAccountSetting') }}">Settings</a>>
                    @endif
                    ...
                    {{-- <a class="dropdown-item" href="{{ route('editPersonalInformationPage') }}">Edit Details</a> --}}
                    @elseif (Auth::guard('employee')->user()->roll_status == 5)
                    <a class="dropdown-item" href="{{ route('hreditPersonalInformationPage') }}">Edit Details</a>
                    @endif

                    @if (Auth::guard('employee')->user()->roll_status == 4)
                    <a class="dropdown-item" href="{{ route('employeeLogout') }}">Logout</a>
                    @elseif (Auth::guard('employee')->user()->roll_status == 3)
                    <a class="dropdown-item" href="{{ route('supervisorLogout') }}">Logout</a>
                    @elseif (Auth::guard('employee')->user()->roll_status == 2)
                    <a class="dropdown-item" href="{{ route('managerLogout') }}">Logout</a>
                    @elseif (Auth::guard('employee')->user()->roll_status == 1)
                    <a class="dropdown-item" href="{{ route('hodLogout') }}">Logout</a>
                    @elseif (Auth::guard('employee')->user()->roll_status == 5)
                    <a class="dropdown-item" href="{{ route('hrLogout') }}">Logout</a>
                    @endif
                  </div>
                </div>
              </li>
            ...
            @yield('employeeprofile')
            @yield('employeeaccount')
            @yield('editemployeeaccount')
            @yield('dashboard')
            @yield('taskcreateprojects')
            @yield('create-page-projects')
            ...
            @yield('userList')
            @yield('edithrProfile')
            @yield('compony_addform')
            @yield('compony_list')
            @yield('leave_list')
            @yield('employee_attendances')
            @yield('department_addform')
            @yield('department_list')
            @yield('leave_approveList')
            @yield('create_employee_designation_page')
            @yield('category_list')
            @yield('create_emp_category')
            @yield('salary_list')
