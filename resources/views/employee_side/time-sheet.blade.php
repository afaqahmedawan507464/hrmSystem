        ...
        <div class="content">
          ...
          <div class="card card-chat overflow-hidden">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-3">
                        <div class="list-group list-group-flush p-5" role="tablist">
                            <!-- <li class="list-unstyled pb-3"> -->
                                <a href="timedashboard" class="list-group-item list-group-item-action active text-start p-2 mb-2"data-toggle="list" role="tab" style="border-radius: 10px;border: 0.5px solid lightgray">Dashboard</a>
                            <!-- </li> -->
                            <!-- <li class="list-unstyled pb-3"> -->
                                <a href="#attendance" class="list-group-item list-group-item-action text-start p-2 mb-2"data-toggle="list" role="tab" style="border-radius: 10px;border: 0.5px solid lightgray">Attendance</a>
                            <!-- </li> -->
                            <!-- <li class="list-unstyled pb-3"> -->
                                <a href="#employeehours" class="list-group-item list-group-item-action text-start p-2 mb-2"data-toggle="list"  role="tab"style="border-radius: 10px;border: 0.5px solid lightgray">Employee Hours</a>
                            <!-- </li> -->
                            <!-- <li class="list-unstyled pb-3"> -->
                                <a href="#leaves" class="list-group-item list-group-item-action text-start p-2 mb-2"data-toggle="list" role="tab" style="border-radius: 10px;border: 0.5px solid lightgray">Leaves</a>
                            <!-- </li> -->
                            <!-- <li class="list-unstyled pb-3"> -->
                                <a href="#worksheet" class="list-group-item list-group-item-action text-start p-2 mb-2" data-toggle="list" role="tab"style="border-radius: 10px;border: 0.5px solid lightgray">Worksheet</a>
                            <!-- </li> -->
                            <!-- <li class="list-unstyled pb-3"> -->
                                <a href="#workshifts" class="list-group-item list-group-item-action text-start p-2 mb-2"data-toggle="list" role="tab"style="border-radius: 10px;border: 0.5px solid lightgray">Work Shifts</a>
                            <!-- </li> -->
                            <!-- <li class="list-unstyled pb-3"> -->
                                <a href="#holidays" class="list-group-item list-group-item-action text-start p-2 mb-2" data-toggle="list" role="tab"style="border-radius: 10px;border: 0.5px solid lightgray">Holidays</a>
                            <!-- </li> -->
                            <!-- <li class="list-unstyled pb-3"> -->
                                <a href="#workfromhome" class="list-group-item list-group-item-action text-start p-2 mb-2" data-toggle="list" role="tab"style="border-radius: 10px;border: 0.5px solid lightgray">Work From Home</a>
                            <!-- </li> -->
                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="tab-content p-5">
                            <div class="tab-pane fade show active" id="timedashboard" role="tabpanel">
                                <div class="card">
                                   <div class="card-header">
                                      <h5 class="card-title mb-0">Dashboard</h5>
                                   </div>
                                   <div class="card-body">
                                      <div class="d-flex" style="margin: 1% 0%;">
                                        <div class="p-3 mb-1" style="border-radius: 5px;border: 0.5px solid lightgray;width: 32%;margin: 0% 1%;">
                                            <div class="row">
                                                <div class="col-6">
                                                    <p class="text-start"><span class="text-black" style="font-size: 40px;"><b>100</b><br></span>
                                                       Employees
                                                    </p>
                                                </div>
                                        ...
                                        <div class="p-3 mb-1" style="border-radius: 5px;border: 0.5px solid lightgray;width: 32%;margin: 0% 1%;">
                                            <div class="row">
                                                <div class="col-6">
                                                    <p class="text-start"><span class="text-black" style="font-size: 40px;"><b>98</b><br></span>
                                                       Present (98%)
                                                    </p>
                                                </div>
                                                <div class="col-6 d-flex justify-content-center align-items-center">
                                        ...
                                        <div class="p-3 mb-1" style="border-radius: 5px;border: 0.5px solid lightgray;width: 32%;margin: 0% 1%;">
                                            <div class="row">
                                                <div class="col-6">
                                                    <p class="text-start"><span class="text-black" style="font-size: 40px;"><b>1</b><br></span>
                                                       Absent (1%)
                                                    </p>
                                                </div>
                                                <div class="col-6 d-flex justify-content-center align-items-center">
                                                    <i class="fa fa-crosshairs" style="font-size: 60px;"></i>
                                                </div>
                                            </div>
                                        </div>
                                      </div>
                                      <div class="d-flex" style="margin: 1% 0%;">
                                        ...
                                        <div class="p-3 mb-1" style="border-radius: 5px;border: 0.5px solid lightgray;width: 32%;margin: 0% 1%;">
                                           <div class="row">
                                                <div class="col-6">
                                                    <p class="text-start"><span class="text-black" style="font-size: 40px;"><b>0</b><br></span>
                                                       Travel (1%)
                                                    </p>
                                                </div>
                                                <div class="col-6 d-flex justify-content-center align-items-center">
                                                    <i class="fa fa-anchor" style="font-size: 60px;"></i>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="p-3 mb-1" style="border-radius: 5px;border: 0.5px solid lightgray;width: 32%;margin: 0% 1%;">
                                           <div class="row">
                                                ...
                                                <div class="col-6 d-flex justify-content-center align-items-center">
                                                    <i class="fa fa-adjust" style="font-size: 60px;"></i>
                                                </div>
                                            </div>
                                        </div>
                                      </div>
                                      <div class="d-flex" style="margin: 1% 0%;">
                                        <div class="p-5 mb-1" style="border-radius: 5px;border: 0.5px solid lightgray;width: 49%;margin: 0% 1%;">hy</div>
                                        <div class="p-5 mb-1" style="border-radius: 5px;border: 0.5px solid lightgray;width: 49%;margin: 0% 1%;">hy</div>
                                      </div>
                                   </div>
                                </div>
                             ...
                             <div class="tab-pane fade" id="employeehours" role="tabpanel">
                               <div class="card">
                                  <div class="card-header">
                                     <h5 class="card-title mb-0">f</h5>
                                  </div>
                                  <div class="card-body">
                            ...
                            <div class="tab-pane fade" id="workshifts" role="tabpanel">
                              <div class="card">
                                  <div class="card-header">
