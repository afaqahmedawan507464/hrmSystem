            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav collapse show" id="dashboard">
                      <li class="nav-item"><a class="nav-link active" href="{{ route('addCompanyForm') }}" aria-expanded="false">
                          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Add Company</span>
                          </div>
                        </a></li>
                        <!-- more inner pages-->
                        <li class="nav-item"><a class="nav-link active" href="{{ route('listCompany') }}" aria-expanded="false">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav collapse show" id="dashboard">
                      <li class="nav-item"><a class="nav-link active" href="{{ route('addDepartmentForm') }}" aria-expanded="false">
                          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Add Department</span>
                          </div>
                        </a></li>
                        <!-- more inner pages-->
                        <li class="nav-item"><a class="nav-link active" href="{{ route('listDepartments') }}" aria-expanded="false">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav collapse show" id="dashboard">
                      <li class="nav-item"><a class="nav-link active" href="{{ route('userRegisterationPage') }}" aria-expanded="false">
                          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">New Employee</span>
                          </div>
                        </a></li>
                        <!-- more inner pages-->
                        <li class="nav-item"><a class="nav-link active" href="{{ route('listEmployee') }}" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">List Employees</span>
                            </div>
                          </a></li>
                          <!-- more inner pages-->
                          <li class="nav-item"><a class="nav-link active" href="{{ route('requestApproval') }}" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Request to approve</span>
                            </div>
                          </a></li>
                          <!-- more inner pages-->
                          <li class="nav-item"><a class="nav-link active" href="{{ route('addEmployeeCategoryForm') }}" aria-expanded="false">
                              <div class="d-flex align-items-center"><span class="nav-link-text ps-1">New employee type</span>
                              </div>
                            </a></li>
                            <!-- more inner pages-->
                            <li class="nav-item"><a class="nav-link active" href="{{ route('listEmployeeCategory') }}" aria-expanded="false">
            ...
            <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
                            ...
                            <div class="notification-avatar">
                              <div class="avatar avatar-xl me-3">
                                @if (!empty(Auth::guard('admin')->user()->image))
                                   <img class="rounded-circle" src="{{ Auth::guard('admin')->user()->image }}" alt="User Image">
                                @else
                                   <img class="rounded-circle" src="admin/dist/img/user2-160x160.jpg" alt="User Image">
                                @endif
              ...
              <li class="nav-item dropdown"><a class="nav-link pe-0" id="navbarDropdownUser" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <div class="avatar avatar-xl">
                    @if (!empty(Auth::guard('admin')->user()->image))
                    <img src="{{asset(Auth::guard('admin')->user()->image)}}" class="rounded-circle">
                    @else
                ...
                <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                  <div class="bg-white dark__bg-1000 rounded-2 py-2">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{{ route('adminAccountSettingPage') }}">Settings</a>
                    <a class="dropdown-item" href="{{ route('adminEditAccountSettingPage') }}">Edit Details</a>
