                   ...
                   <div class="card bg-light d-flex flex-fill">
                      ...
                      <div class="card-footer">
                        <div class="text-right">
                           <a href="{{ route('hrleaveRejected',$item->id) }}" class="btn btn-sm bg-danger text-white">
                           Dismiss Leave
                           </a>
                           <a href="{{ route('hrleaveApprove',$item->id) }}" class="btn btn-sm btn-primary">
                           <i class="fas fa-user px-1"></i> Accept Leave
                           </a>
                        </div>
                     </div>
                      @else
                      <div class="card-footer">
                        <div class="text-right">
                           <a href="{{ route('leaveRejected',$item->id) }}" class="btn btn-sm bg-danger text-white">
                           Dismiss Leave
                           </a>
                           <a href="{{ route('leaveApprove',$item->id) }}" class="btn btn-sm btn-primary">
                           <i class="fas fa-user px-1"></i> Accept Leave
                           </a>
                        </div>
                     </div>
