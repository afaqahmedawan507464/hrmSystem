      ...
      <div class="container-fluid">
        ...
        <div class="row min-vh-100 bg-100">
          <div class="col-6 d-none d-lg-block position-relative">
            <div class="bg-holder" style="background-image:url(/public/assets/img/generic/19.jpg);">
            </div>
            <!--/.bg-holder-->
          ...
          <div class="col-sm-10 col-md-6 px-sm-0 align-self-center mx-auto py-5">
            <div class="row justify-content-center g-0">
              <div class="col-lg-9 col-xl-8 col-xxl-6">
                ...
                @endif
                <div class="card">
                  <div class="card-header bg-circle-shape bg-shape text-center p-2"><a class="font-sans-serif fw-bolder fs-4 z-index-1 position-relative link-light light" href="../../../index.html">Codemindz</a></div>
                  <div class="card-body p-4">
                    ...
                    <form action="{{ route('employeeRegisteration') }}" method="post">
                        @csrf
                        @if ($select_company_details->isEmpty())

                        @else
                           @foreach ($select_company_details as $company)
                           @endforeach
                           <div class="mb-3" style="visibility: hidden;">
                               <label class="form-label" for="split-name">Name</label>
                               <input class="form-control" type="text" name="companyname" value="{{ $company->id }}" />
                           </div>
                        @endif
                      ...
                      <div class="mb-3">
                        <label class="form-label" for="split-name">Name</label>
                        <input class="form-control" type="text" autocomplete="off" name="fullname" value="{{old('fullname')}}" />
                      </div>
                      <div class="mb-3">
                        <label class="form-label" for="split-email">Email address</label>
                        <input class="form-control" type="email" autocomplete="off" name="emailaddress" value="{{old('emailaddress')}}" />
                      </div>
                      <div class="row gx-2">
                        ...
                        <div class="mb-3 col-sm-6">
                          ...
                          <input class="form-control" type="password" autocomplete="off" name="retypepassword" />
                        </div>
                        @if ($departments->isEmpty())

                        @else
                        <div class="mb-3 col-12">
                            <label class="form-label" for="split-confirm-password">Departments</label>
                        ...
                        @if ($select_employee_category->isEmpty())

                        @else
                        <div class="mb-3 col-12">
                            <label class="form-label" for="split-confirm-password">Employee Category</label>
                            <select name="employee_category" id="employee_category" class="form-control">
                                <option value="">Select Employee Category</option>
                                @foreach ($select_employee_category as $empCat)
                                   <option value="{{ $empCat->id }}">{{ $empCat->employee_category_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        @endif
                        <div class="mb-3 col-12">
                            <label class="form-label" for="split-confirm-password">Employee Roll</label>
                            <select name="basic_role" id="basic_role" class="form-control">
                                <option value="">Select Employee Type</option>
                                <option value="1">head of department</option>
                                <option value="2">manager of department</option>
                                <option value="3">supervisor of department</option>
                                <option value="4">basic employee</option>
                                {{-- <option value="5">Hr Person</option> --}}
                            </select>
                        </div>
                      </div>
                      <div class="mb-3">
                    ...
                    @else
                    <form action="{{ route('userRegisteration') }}" method="post">
                        @csrf
                        @if ($select_company_details->isEmpty())
