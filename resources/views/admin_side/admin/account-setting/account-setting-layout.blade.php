    ...
    <div class="col-lg-8 pe-lg-2">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body bg-light">
                <form class="row g-3" method="post" action="{{ route('adminAccountSetting') }}" enctype="multipart/form-data">
                    @csrf
                <div class="col-lg-12">
                ...
                <div class="col-lg-6">
                  ...
                  <input type="email" class="form-control" id="emailaddress" name="emailaddress" placeholder="Enter email address" value="{{old('emailaddress')}}{{ $item->email }}" disabled>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    ...
                    <input type="number" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Enter Mobile Number" value="{{old('mobilenumber')}}{{ $item->mobile }}">
                </div>
                <hr>
                <div class="col-lg-6">
