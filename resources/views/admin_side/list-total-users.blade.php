                                ...
                                <table class="table">
                                   <thead class="bg-primary text-white">
                                      <tr>
                                         ...
                                         <th scope="col" style="width: 5%;text-align:center">Online</th>
                                         <th scope="col" style="width: 5%;text-align:center">Account Active</th>
                                         <th scope="col" style="width: 28%;text-align:center">Operation</th>
                                      </tr>
                                   </thead>
                                   <tbody>
                                    @foreach ($totalemployees as $item)
                                      ...
                                      <tr>
                                         ...
                                         <td style="width: 5%;text-align:center;padding:10px 20px">
