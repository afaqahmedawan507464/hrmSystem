      ...
      <div class="container-fluid">
        ...
        <div class="row min-vh-100 bg-100">
          <div class="col-6 d-none d-lg-block position-relative">
            <div class="bg-holder" style="background-image:url(/public/assets/img/generic/14.jpg);background-position: 50% 20%;">
            </div>
            <!--/.bg-holder-->
                  ...
                  <div class="card-body p-4">
                    ...
                    <form action="{{ route('adminLogin') }}" method="post">
                      ...
                      <div class="mb-3">
                        ...
                        <input class="form-control" id="split-login-email" type="email" name="emailaddress" id="emailaddress" value="{{ old('emailaddress') }}" />
                      </div>
                      <div class="mb-3">
                        <div class="d-flex justify-content-between">
                          <label class="form-label" for="split-login-password">Password</label>
                        </div>
                        <input class="form-control" id="split-login-password" type="password" name="password" id="password" />
                      </div>
                      <div class="row flex-between-center">
                        <div class="col-auto">
